...
for (a in 1:length(sp_names)){
  ...
  ## RCP45
  raster_files2 <- list.files(paste0("./outputs/", sp.n, "/Fut_env_crop/", RCP1), full.names = T, 'tif$|bil$')
  head(raster_files2)
  ...
  ####RCP85
  raster_files3 <- list.files(paste0("./outputs/", sp.n, "/Fut_env_crop/", RCP2), full.names = T, 'tif$|bil$')
  head(raster_files3)
